...
export const GloxiniaClosing = ({ locale, text }: GloxiniaClosingProps) => {
  ...
  return (
    ...
    <Flex
      alignItems="center"
      as="section"
      backgroundImage="url('/gloxinia-story/closing-banner.webp')"
    ...
    >
      <Box
        ...
        position="absolute"
      />
      <Flex alignItems="center" direction="column" maxWidth="900px" position="relative" zIndex={1}>
        <Text
          color="#384431"
        ...
        {locale === 'ru' ? (
          <Image
            ...
            src="/gloxinia-story/story-continues-signature.png"
