...
const araceaeSeed: FamilyDetailSeed = {
  closingNote: {
    en: 'Aroids are more than houseplants: they are a world of remarkable forms and adaptations.',
    ru: 'Ароидные — это не просто растения, это целый мир удивительных форм и адаптаций.',
  },
  description: {
    en: 'Aroids are one of the largest families of flowering plants. Most members come from tropical and subtropical regions and are known for dramatic foliage, aerial roots, and spadix-and-spathe inflorescences.',
  ...
  origin: {
    ...
    ru: 'Тропические и субтропические регионы Азии, Центральной и Южной Америки, Африки, Австралии и островов Тихого океана.',
  },
...
const familySeeds: Record<CategoryId, FamilyDetailSeed> = {
  ...familySeedsJson,
  araceae: araceaeSeed,
};
