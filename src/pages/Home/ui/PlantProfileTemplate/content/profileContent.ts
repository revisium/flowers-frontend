...
export const profileFooter = {
  en: {
    ...
    propagation:
      'Propagate by stem cuttings during the period of active growth in water or a slightly moist, breathable substrate.',
  },
  ru: {
    facts: [
    ...
    propagation:
      'Размножайте стеблевыми черенками в период активного роста в воде или слегка влажном, воздухопроницаемом субстрате.',
  },
} as const;
