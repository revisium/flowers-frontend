...
const homeCategoryDefinitions: readonly HomeCategoryDefinition[] = [
  ...
  },
  {
    count: { en: '2 plants', ru: '2 растения' },
    id: 'commelinaceae',
    image: '/plants/categories/studio/commelinaceae.webp',
  ...
  },
  {
    count: { en: '2 plants', ru: '2 растения' },
    id: 'asphodelaceae',
    image: '/plants/categories/studio/asphodelaceae.webp',
    name: { en: 'Asphodel family', ru: 'Асфоделовые' },
  },
  {
    count: { en: '0 plants', ru: '0 растений' },
    id: 'crassulaceae',
    image: '/plants/categories/studio/crassulaceae-table.webp',
  ...
  },
  {
    ...
    id: 'cactaceae',
    image: '/plants/categories/studio/cactaceae.webp',
    name: { en: 'Cacti', ru: 'Кактусовые' },
  },
  {
    count: { en: '4 plants', ru: '4 растения' },
    id: 'bromeliaceae',
    image: '/plants/categories/studio/bromeliaceae.webp',
  ...
  },
  {
    count: { en: '1 plant', ru: '1 растение' },
    id: 'moraceae',
    image: '/plants/categories/studio/moraceae-clean.webp',
    imageObjectPosition: 'center',
    imageScale: '1',
  ...
  },
  {
    count: { en: '1 plant', ru: '1 растение' },
    id: 'vitaceae',
    image: '/plants/categories/studio/vitaceae.webp',
    name: { en: 'Grape family', ru: 'Виноградовые' },
  },
  {
    count: { en: '1 plant', ru: '1 растение' },
    id: 'cycadaceae',
    image: '/plants/categories/studio/cycadaceae.webp',
    name: { en: 'Cycads', ru: 'Саговниковые' },
  },
  {
    count: { en: '1 plant', ru: '1 растение' },
    id: 'lamiaceae',
    image: '/plants/categories/studio/lamiaceae.webp',
    imageObjectPosition: 'center',
    imageScale: '1',
